        ...
        children: [
          Container(
            ...
            child: const CircleAvatar(
              backgroundImage: AssetImage('profileshiva.jpeg'),
              backgroundColor: Color.fromARGB(248, 27, 56, 247),
              radius: 50.0,
            ),
          ),
          const Spacer(),
              ...
              children: [
                Row(
                  children: [
                    ...
                    const Spacer(),
                    Text('085021024', style: vkTextCardBold),
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                Text('Shiva Agastasia', style: vkTextLightGrey),
              ],
            ),
          ),
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                Text('Shiva', style: vkTextLightGrey),
              ],
            ),
          ),
          const Divider(color: Color(0xffee8301)),
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Jl. Durian Raya No. 45 Baranangsiang Bogor Timur, Bogor, Jawa Barat, Indonesia, 16143',
